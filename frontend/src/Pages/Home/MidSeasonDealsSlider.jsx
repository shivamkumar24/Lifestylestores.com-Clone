    ...
    <>
      ...
      <Box width="90%" margin="25px auto">
        <Image
          ...
          objectFit="cover"
          borderRadius={"20px"}
          src="https://lmsin.net/cdn-cgi/image/w=1232,q=70,fit=cover/https://70415bb9924dca896de0-34a37044c62e41b40b39fcedad8af927.lmsin.net/LS-Fest/LS-new/Uber-HP-Desktop-ModularBlocks4-11May2023.jpg"
        />
      </Box>
    </>
  );
...
export default MidSeasonDealsSlider;
