...
const AdminBag = () => {
  ...
  const getBag = async () => {
    try {
      const response = await axios.get(
        `https://calm-tutu-bass.cyclic.app/bag/`
      );
  ...
  const deleteBag = async (user_id) => {
    ...
    axios
      .delete(`https://calm-tutu-bass.cyclic.app/bag/delete/${id}`)
      .then((res) => {
        toast({
          title: res.data.msg,
          status: "success",
  ...
  const AddNewBag = () => {
    axios
      .post(`https://calm-tutu-bass.cyclic.app/bag/add`, NewBagData)
      .then((res) => {
        toast({
          title: res.data.msg,
          status: "success",
