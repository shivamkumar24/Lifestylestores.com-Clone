...
const AdminWomen = () => {
  ...
  const getWomen = async () => {
    try {
      const response = await axios.get(
        `https://calm-tutu-bass.cyclic.app/women/`
      );
  ...
  // ------------------------- Delete Women ----------------------
  const deleteWomen = async (user_id) => {
    const id = user_id;

    axios
      .delete(`https://calm-tutu-bass.cyclic.app/women/delete/${id}`)
      .then((res) => {
        toast({
          title: res.data.msg,
          status: "success",
  ...
  const AddNewWomen = () => {
    axios
      .post(`https://calm-tutu-bass.cyclic.app/women/add`, NewWomenData)
      .then((res) => {
        toast({
          title: res.data.msg,
          status: "success",
