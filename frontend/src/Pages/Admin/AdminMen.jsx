...
const AdminMen = () => {
  ...
  const getMen = async () => {
    try {
      const response = await axios.get(
        `https://calm-tutu-bass.cyclic.app/men/`
      );
  ...
  // ------------------------- Delete Men ----------------------
  const deleteMen = async (user_id) => {
    const id = user_id;

    axios
      .delete(`https://calm-tutu-bass.cyclic.app/men/delete/${id}`)
      .then((res) => {
        toast({
          title: res.data.msg,
          status: "success",
  ...
  const AddNewMen = () => {
    axios
      .post(`https://calm-tutu-bass.cyclic.app/men/add`, NewMenData)
      .then((res) => {
        toast({
          title: res.data.msg,
          status: "success",
